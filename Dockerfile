...
RUN --mount=type=cache,target=/root/.ccache \
    ...
    CUDA_DIST_DIR="/go/src/github.com/ollama/ollama/dist/linux-arm64/lib/ollama/cuda_jetpack6" \
...
RUN --mount=type=cache,target=/root/.ccache \
    ...
    CUDA_DIST_DIR="/go/src/github.com/ollama/ollama/dist/linux-arm64/lib/ollama/cuda_jetpack5" \
